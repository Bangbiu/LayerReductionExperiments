...
# Reduced AlexNet: 3 Conv + 2 FCs
class ANR_Conv3_4_5_2FC(nn.Module):
    layerToTrain = ["fc"]
    def __init__(self, num_classes=5):
        super(ANR_Conv3_4_5_2FC, self).__init__()
        self.conv1 = nn.Conv2d(in_channels=3, out_channels=96,
                               kernel_size=11, stride=4, padding=0)
        self.maxpool = nn.MaxPool2d(kernel_size=3, stride=2)
        self.conv2 = nn.Conv2d(in_channels=96, out_channels=256,
        ...
        self.fc3 = nn.Linear(in_features=43264, out_features=num_classes)
...
class ANR_Conv4_5_2FC(nn.Module):
    layerToTrain = ["fc"]
    def __init__(self, num_classes=5):
        super(ANR_Conv4_5_2FC, self).__init__()
        self.conv1 = nn.Conv2d(in_channels=3, out_channels=96,
                               kernel_size=11, stride=4, padding=0)
        self.maxpool = nn.MaxPool2d(kernel_size=3, stride=2)
        self.conv2 = nn.Conv2d(in_channels=96, out_channels=256,
        ...
        self.conv3 = nn.Conv2d(in_channels=256, out_channels=384,
                               kernel_size=3, stride=1, padding=1)
        self.fc3 = nn.Linear(in_features=64896, out_features=num_classes)
